...
//					promotionControl.msg = new H.util.Msg();
//				}
				...
				save : function() {
						...
						if(minAmount || maxAmount ){
							result = createGroup.checkPrice(minAmount);
							result1 = createGroup.checkPrice(minAmount);
							error = result[0];
							error1 = result1[0];
							msg = result[1];
							if(error || error1){
						...
						if(minAvg || maxAvg ){
							result = createGroup.checkPrice(minAvg);
							result1 = createGroup.checkPrice(maxAvg);
							error = result[0];
							error1 = result1[0];
							msg = result[1];
							if(error || error1){
						...
						var sucessHandle = function(o) {
				 		...
				 		var data = '';
				 		createGroup.msg.setMsg('正在保存中，请稍候').show();
