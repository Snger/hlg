 ...
 * @author  
 */
KISSY.add('utils/asyncRequest/index',function (S,msgBox) {
 ...
 * @author  
 */
KISSY.add('utils/MsgBox/index',function (S) {
 ...
 * @author  
 */
KISSY.add('page/acountInit',function (S,msgBox,msg) {
    // your code here
